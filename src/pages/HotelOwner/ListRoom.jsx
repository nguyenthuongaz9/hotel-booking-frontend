            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={()=> navigate(`/rooms/${room.id}`)} className="flex-1 px-3 py-2 bg-gray-600 text-white text-sm rounded-lg hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors">
                    Chi tiết
                  </button>
                </div>
              </div>
